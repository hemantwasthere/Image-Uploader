        ...
        <div className='grid grid-cols-2  '>
            <div className="flex col-span-1 h-fit fixed ml-40 mt-20">
                <div className={`max-w-2xl rounded-lg shadow-xl ${theme === 'dark' ? 'bg-[#535352]' : 'bg-gray-50'}`}>
                    ...
                    <div className="m-4">
                        <label className={`inline-block mb-2 ${theme === 'dark' ? 'text-white' : 'text-gray-500'}`}>File Upload</label>
                    ...
                    <div className="flex justify-center flex-col p-2">
                        ...
                        <button onClick={handlePublish} className="w-full my-2 px-4 py-2 text-white bg-[#3f51d8] rounded shadow-xl">
